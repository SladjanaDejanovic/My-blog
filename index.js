...
const article3 =
  "Euismod quis viverra nibh cras pulvinar mattis nunc sed. Mattis rhoncus urna neque viverra justo. Orci eu lobortis elementum nibh tellus molestie. Montes nascetur ridiculus mus mauris vitae ultricies.";
const article4 =
  "Senectus et netus et malesuada. Tincidunt arcu non sodales neque. Sagittis orci a scelerisque purus semper eget.";
...
app.get("/articles", (req, res) => {
  ...
  posts.forEach((post) => {
    post.showReadMore =
      post.content.length > maxLength || post.content.length > 100;
  });

  res.render("pages/articles", { user, posts: posts, title: "Articles" });
});
